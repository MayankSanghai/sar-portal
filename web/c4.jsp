...
ResultSet rs=stat.executeQuery("select * from ppublication where Id='"+Id+"'");
if(rs.next())
{
%>
<%@taglib tagdir="/WEB-INF/tags" prefix="ob" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="mid_float">
            ...
            <form action="UpdateDatac4" method="post" autocomplete="off">
        <table id="tableid" width="500" height="150">
            <caption><h3>Publication Details</h3></caption>
                <td></td>
          <tr>
           <td width="300" height="47">Title</td>
           <td width="300" height="47"><input type="text" name="Title" value="<%=rs.getString(2) %>"></td>
           </tr>
           <tr>
                <td width="300" height="50">Description</td>
                <td width="300" height="50"><textarea rows="3" name="Description"><%=rs.getString(3) %></textarea></td>
            </tr>
          <tr>
                <td width="300" height="50">Date</td>
                <td width="300" height="50">
                    <div class="input-group date" data-provide="datepicker">
                    <input type="text" class="form-control" autocomplete="off" name="Date" value="<%=rs.getString(4)%>">
        ...
        <br>
            <table id="tableid1" width="500" height="50">
                <tr>
                <form action="UpdateFilec4" enctype="multipart/form-data"  method="post" onSubmit="return validation(this)">
        ...
        <script type="text/javascript">
            var Msg ='<%=session.getAttribute("getAlertc4")%>';
            if (Msg != "null")
            {
                function alertName()
                {
        ...
        <script type="text/javascript"> window.onload = alertName; <%session.setAttribute("getAlertc4", "null"); %></script>
    </body>
</html>   
<%
}
