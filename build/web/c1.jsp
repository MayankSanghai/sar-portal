...
ResultSet rs=stat.executeQuery("select * from presearch where Id='"+Id+"'");
if(rs.next())
{
%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="mid_float">
            <div id="infodiv">
           <form action="UpdateDatac1" method="post" autocomplete="off">
            <table id="tableid" width="500" height="150">
            <caption><h3>Research Papers Details</h3></caption>
                <td></td>
          <tr>
           <td width="300" height="47">Paper title</td>
           <td width="300" height="47"><input type="text" name="Title" value="<%=rs.getString(2) %>"></td>
           </tr>
           <tr>
           <td width="300" height="47">Presented at</td>
           <td width="300" height="47"><input type="text" name="PresentedAt" value="<%=rs.getString(3) %>"></td>
           </tr>
            <tr>
         ...
         <br>
            <table id="tableid1" width="500" height="50">
                <tr>
                <form action="UpdateFilec1" enctype="multipart/form-data"  method="post" onSubmit="return validation(this)">
        ...
        <script type="text/javascript">
            var Msg ='<%=session.getAttribute("getAlertc1")%>';
            if (Msg != "null")
            {
                function alertName()
                {
        ...
        <script type="text/javascript"> window.onload = alertName; <%session.setAttribute("getAlertc1", "null"); %></script>
    </body>
</html>   
<%
}
