...
ResultSet rs=stat.executeQuery("select * from pintern where Id='"+Id+"'");
if(rs.next())
{
%>
...
<!--        <script language="javascript">
    ...
    <body>
        ...
        <form action="UpdateDataa4" method="post" autocomplete="off">
        <table id="tableid" width="500" height="150">
            <caption><h3>Internship Information</h3></caption>
            <td></td>
            <tr>
                <td width="300" height="50">Name of company</td>
            ...
            <tr>
                <td width="300" height="50">Start date</td>
            ...
            <tr>
                <td width="300" height="50">End Date</td>
                <td width="300" height="50">
                    <div class="input-group date" data-provide="datepicker">
                    <input type="text" class="form-control" autocomplete="off" name="EndDate" id="EndDate" value="<%=rs.getString(5)%>">
                    <div class="input-group-addon">
                        <span class="glyphicon glyphicon-th"></span>
                    </div>    
               </div></td>
            ...
            <table id="tableid1" width="500" height="50">
                <tr>
                <form action="UpdateFilea4" enctype="multipart/form-data"  method="post" onSubmit="return validation(this)">
                ...
                <td width="157" height="42">
                    ...
                    <script type="text/javascript">
            var Msg ='<%=session.getAttribute("getAlerta4")%>';
            if (Msg != "null")
            {
                function alertName()
                {
        ...
        <script type="text/javascript"> window.onload = alertName; <%session.setAttribute("getAlerta4", "null"); %></script>
    </body>
</html>   
<%
}
