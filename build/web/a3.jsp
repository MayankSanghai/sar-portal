...
ResultSet rs=stat.executeQuery("select * from pstartup where Id='"+Id+"'");
if(rs.next())
{
%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="mid_float">
            <div id="infodiv">
            <form action="UpdateDataa3" method="post" autocomplete="off">
                <table id="tableid" width="500" height="150">
                    <caption><h3>Startup Information</h3></caption>
                    <td></td>
                <tr>
                ...
                <tr>
                    ...
                    <td width="300" height="50"><textarea rows="3" name="Description"><%=rs.getString(4) %></textarea></td>
                </tr>
                <tr>
                    <td width="300" height="50">Start date</td>
                    <td width="300" height="50">
                        <div class="input-group date" data-provide="datepicker">
                        <input type="text" class="form-control" autocomplete="off" name="StartDate" id="StartDate" value="<%=rs.getString(3)%>">
            ...
            <table id="tableid1" width="500" height="50">
                <tr>
                <form action="UpdateFilea3" enctype="multipart/form-data"  method="post" onSubmit="return validation(this)">
        ...
        <script type="text/javascript">
            var Msg ='<%=session.getAttribute("getAlerta3")%>';
            if (Msg != "null")
            {
                function alertName()
                {
        ...
        <script type="text/javascript"> window.onload = alertName; <%session.setAttribute("getAlerta3", "null"); %></script>
    </body>
</html>   
<%
}
