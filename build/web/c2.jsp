...
ResultSet rs=stat.executeQuery("select * from pinnovation where Id='"+Id+"'");
if(rs.next())
{
%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="mid_float">
           ...
           <form action="UpdateDatac2" method="post" autocomplete="off">
        <table id="tableid" width="500" height="150">
            <caption><h3>Innovation</h3></caption>
                <td></td>
          <tr>
                <td width="300" height="47">Details</td>
                <td width="300" height="47"><textarea rows="3" name="Details"><%=rs.getString(2) %></textarea></td>
            </tr>
          <tr>
                <td width="300" height="47">Date</td>
                <td width="300" height="47">
                    <div class="input-group date" data-provide="datepicker">
                    <input type="text" class="form-control" autocomplete="off" name="Date"value="<%=rs.getString(3)%>">
        ...
        <br>
            <table id="tableid1" width="500" height="50">
                <tr>
                <form action="UpdateFilec2" enctype="multipart/form-data"  method="post" onSubmit="return validation(this)">
        ...
        <script type="text/javascript">
            var Msg ='<%=session.getAttribute("getAlertc2")%>';
            if (Msg != "null")
            {
                function alertName()
                {
        ...
        <script type="text/javascript"> window.onload = alertName; <%session.setAttribute("getAlertc2", "null"); %></script>
    </body>
</html>   
<%
}
